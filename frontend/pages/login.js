...
const login = ({ csrfToken }) => {
    ...
    return (
        <div className='container'>
            <Head>
                <title>Login | Arionys</title>
                <meta
                    name="description"
                    content="Log in to your Arionys account to continue your coding journey! Access your favorite programming tutorials, participate in coding challenges, and stay updated with the latest tech blogs."
                />
                <meta
                    name="keywords"
                ...
                <meta property="og:title" content="Login | Arionys" />
                <meta
                    property="og:description"
                    content="Log in to Arionys to access your coding content, participate in challenges, and read tech insights from leading developers."
                />
                <meta property="og:image" content={appLogoUrl} />
                <meta property="og:url" content="https://Arionys.com/login" />
                <meta property="og:type" content="website" />
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content="Login | Arionys" />
                <meta
                    name="twitter:description"
                    content="Sign in to continue your coding journey with Arionys. Access exclusive content, challenges, and more!"
                />
