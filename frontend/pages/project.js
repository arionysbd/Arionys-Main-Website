...
export default function Blog({ blogs }) {
    ...
    return (
        <>
            <Head>
                <title>Our Projects | Arionys - Robotics & Innovation</title>
                <meta
                    name="description"
                    content="Explore Arionys's innovative robotics projects, technology milestones, and recent achievements. Learn about our groundbreaking work in education and automation."
                />
                <meta name="viewport" content="width=device-width, initial-scale=1" />
                <link rel="icon" href="/favicon.ico" />

                <meta property="og:type" content="website" />
                <meta property="og:title" content="Our Projects | Arionys" />
                <meta
                    property="og:description"
                    content="Explore Arionys's innovative projects and groundbreaking work in robotics, automation, and education. Stay up to date with our latest technological advancements."
                />
                <meta property="og:url" content={`${process.env.SITE_URL}/projects`} />
                <meta property="og:image" content='/img/projectthum.png' />

                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content="Our Projects | Arionys" />
                <meta
                    name="twitter:description"
                    content="Explore Arionys's latest robotics and automation projects. Learn how our innovative technologies are shaping the future."
                />
                                        ...
                                        <div className="blogimg">
                                            <Link href={`/project/${blog.slug}`}>
                                                <Image
                                                    ...
                                                    alt={`Image for ${blog.title} - Arionys Robotics Project`}
