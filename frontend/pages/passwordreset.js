...
const passwordreset = () => {
    ...
    return (
        <div className='container'>
            <Head>
                <title>Password Reset | Arionys</title>
                <meta
                    name="description"
                    content="Forgot your password? Reset it easily to regain access to your Arionys account and continue exploring our programming tutorials, challenges, and tech blogs."
                />
                <meta
                    name="keywords"
                ...
                <meta property="og:title" content="Password Reset | Arionys" />
                <meta
                    property="og:description"
                    content="Reset your Arionys password to regain access to top-quality programming content, challenges, and tech insights."
                />
                <meta property="og:image" content={appLogoUrl} />
                <meta property="og:url" content="https://Arionys.com/password-reset" />
                <meta property="og:type" content="website" />
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content="Password Reset | Arionys" />
                <meta
                    name="twitter:description"
                    content="Recover your account quickly by resetting your password. Get back to coding and stay connected with the Arionys community."
                />
