...
const Members = ({ members }) => {
    ...
    return (
        <>
            <Head>
                <title>Meet Our Team | Arionys</title>
                <meta name="description" content="Meet the talented team members of Arionys, our experts in robotics, technology, and innovation." />
                <meta name="keywords" content="team, robotics, engineering, innovation, technology" />
                <meta name="author" content="Arionys" />

                {/* Open Graph */}
                <meta property="og:type" content="website" />
                <meta property="og:title" content="Meet Our Team | Arionys" />
                <meta property="og:description" content="Meet the talented team members of Arionys, experts in robotics and technology." />
                <meta property="og:image" content="/img/team.png" />
                <meta property="og:url" content={`${process.env.SITE_URL}/members`} />

                {/* Twitter */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content="Meet Our Team | Arionys" />
                <meta name="twitter:description" content="Meet the talented team members of Arionys, experts in robotics and technology." />
