...
export default function Setting() {
  ...
  return (
    <>
      <Head>
        <title>Settings | Arionys</title>
        <meta
          name="description"
          content="Manage your profile settings on Arionys. Update your personal information, change your password, and customize your account preferences easily."
        />
        <meta
          name="keywords"
          content="settings, profile settings, account management, update information, change password, customize profile, Arionys"
        />
        <meta name="author" content="Arionys" />
        <meta property="og:title" content="Settings | Arionys" />
        <meta
          property="og:description"
          content="Easily update your profile information and account settings on Arionys. Personalize your experience and manage your account with ease."
        />
        <meta property="og:image" content={appLogoUrl} />
        <meta property="og:url" content="https://Arionys.com/settings" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Settings | Arionys" />
        <meta
          name="twitter:description"
          content="Access your settings on Arionys to update your profile and account preferences. Personalize your experience today!"
        />
