...
const ShortURL = () => {
    ...
    const siteUrl = process.env.SITE_URL || 'https://Arionys.com'; // Fallback if SITE_URL is not set
    useEffect(() => {
    ...
    return (
        <>
            <Head>
                {/* Primary Meta Tags */}
                <title>Arionys - URL Shortener</title>
                <meta
                    name="description"
                    content="Arionys provides powerful tools like a Short URL Generator to enhance your productivity and simplify your online tasks. Discover innovative solutions today!"
                />
                <meta
                    name="keywords"
                    content="Arionys, Short URL Generator, link management, SEO tools, productivity solutions, online tools"
                />
                <meta name="author" content="Arionys" />
                <meta name="viewport" content="width=device-width, initial-scale=1.0" />
                <meta name="robots" content="index, follow" />

                {/* Open Graph Meta Tags (For Social Media Sharing) */}
                <meta property="og:title" content="Arionys - URL Shortener" />
                <meta
                ...
                <meta name="twitter:title" content="Arionys - URL Shortener" />
                <meta
                ...
                <script type="application/ld+json">
                    {JSON.stringify({
                        ...
                        "@type": "WebSite",
                        "name": "Arionys",
                        "url": "https://Arionys.com",
                        "description": "Arionys offers cutting-edge tools and services including a URL shortener, private note tools, and more. Simplify your online tasks with our innovative solutions.",
                        "publisher": {
                            "@type": "Organization",
                            "name": "Arionys",
                            "logo": {
                        ...
                        "sameAs": [
                            "https://www.facebook.com/Arionys",
                            "https://twitter.com/Arionys",
                            "https://www.linkedin.com/company/Arionys"
                        ]
                    })}
                </script>
            </Head>
                                ...
                                {urls.length === 0 && (
                                    <tr>
                                        <td colSpan="5" className="px-4 py-2 text-center text-gray-600 dark:text-gray-300">
                                            ...
                                            <span><Link className="underline" target="_blank" href="https:Arionys.com/api/XT8_S_sgc"> https:Arionys.com/api/XT8_S_sgc</Link></span>
                                        </td>
                                    </tr>
                                )}
                            </tbody>
