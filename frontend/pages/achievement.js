...
export default function Blog({ blogs }) {
    ...
    return (
        <>
            <Head>
                <title>Achievements | Arionys</title>
                <meta
                    name="description"
                    content="Explore the recent achievements and milestones of Arionys. Stay updated with our team's progress in robotics, technology, and education."
                />
                ...
                <meta property="og:title" content="Achievements | Arionys" />
                <meta
                    property="og:description"
                    content="Explore the latest accomplishments of Arionys in robotics, innovation, and education. Read our achievements and progress in various competitions."
                />
                ...
                <meta name="twitter:title" content="Achievements | Arionys" />
                <meta
                    name="twitter:description"
                    content="Stay updated with Arionys's latest achievements in the world of robotics, education, and technology."
                />
                ...
                <script
                    ...
                    dangerouslySetInnerHTML={{
                        __html: JSON.stringify({
                            ...
                            description:
                                "Explore the recent achievements of Arionys in robotics, coding, and technology innovations.",
                            image: "/img/blog.png",
                            author: {
                                "@type": "Organization",
                                name: "Arionys",
