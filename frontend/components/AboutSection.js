...
const structuredData = {
    ...
    "@type": "Company",
    "name": "Arionys",
    "description": "Arionys is a leading company dedicated to advancing software development, innovative solutions, and IT project management in Bangladesh.",
                ...
                <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
                    <div data-aos="zoom-in-right" className="col-span-4 sm:col-span-3">
                        <div className="bg-white dark:bg-slate-700 shadow rounded-lg p-6">
                            <div className="flex flex-col items-center">
                                ...
                                <Image src={"/img/Coder.png"} alt='Arionys' height={"100"} width={"100"} className="w-32 h-32 bg-gray-300 rounded-full mb-4 shrink-0" />
                                <h1 className="text-xl font-bold dark:text-gray-50">Arionys</h1>
                            ...
                            <div className="flex flex-col">
                                ...
                                <ul>
                                    ...
                                    <Link href={"/members"}><li className="mb-2 dark:text-gray-50">Employees</li></Link>
                    ...
                    <div data-aos="zoom-in-left" className="col-span-4 sm:col-span-9">
                        <div className="bg-white dark:bg-slate-700 shadow rounded-lg p-6">
                            ...
                            <p className="text-gray-70 dark:text-gray-50">Arionys: Building the Future of Software in Bangladesh


                                .
                                <br /><br />
                                Arionys is dedicated to advancing software development, innovative solutions, and IT project management in Bangladesh. Our goal is to cultivate a robust environment for technology professionals and enthusiasts through high-quality education, practical experience, and a supportive community.
                                ...
                                <br /><br />
                                We are committed to shaping the next generation of software engineers and technologists. Our programs cater to various skill levels, offering a blend of practical workshops, comprehensive theoretical courses, and engaging extracurricular activities to foster expertise and curiosity in software development.
                                <br /><br />
                               At Arionys, we believe that innovation thrives at the intersection of knowledge and application. We emphasize bridging the gap between academic learning and real-world challenges. Through project-based learning, mentorship, and collaborative initiatives, we prepare our members to excel in dynamic and evolving fields.
                                <br /><br />
                                Our focus on software development and IT project management ensures our community is equipped with the necessary skills to lead in the technological landscape. Together, we empower individuals to envision and achieve significant advancements.
                                <br /><br />
                                Join us in our mission to enhance education, foster innovation, and drive excellence. Together, we are Arionys—pioneering the future of technology and engineering in Bangladesh.
                            ...
                            <div className="flex justify-center items-center gap-6 my-6">
                                ...
                                <Link className="text-gray-700 dark:text-gray-50 hover:text-orange-600" aria-label="Visit TrendyMinds Facebook" href="https://www.facebook.com/arionysbd"
                                    target="_blank">
                                ...
                                <Link className="text-gray-700 dark:text-gray-50 hover:text-orange-600" aria-label="Visit TrendyMinds Twitter" href="https://x.com/"
                                    target="_blank">
