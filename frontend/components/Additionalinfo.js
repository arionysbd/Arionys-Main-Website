                    ...
                    <div data-aos="zoom-in-right" className="lg:pr-8">
                        <div className="lg:max-w-lg">
                            ...
                            <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
                                Empowering the Future through Software and Innovation.
                            </p>
                            ...
                            <dl className="mt-10 space-y-8 text-base leading-7 text-gray-600">
                                ...
                                <div className="relative pl-9">
                                    ...
                                    <dd className="inline dark:text-gray-400">
                                        <br />At Arionys, we develop high-quality, scalable, and secure software tailored to meet your business needs — from web and mobile applications to enterprise systems and cloud platforms.
                                    </dd>
                                </div>
                                ...
                                <div className="relative pl-9">
                                    ...
                                    <dd className="inline dark:text-gray-400">
                                        <br />We thrive on solving complex problems through smart software engineering. Our projects span across AI integration, IoT ecosystems, automation tools, and data-driven platforms that accelerate digital transformation.
                                    </dd>
                                </div>
                                ...
                                <div className="relative pl-9">
                                    <dt className="dark:text-gray-200 inline font-semibold text-gray-900">
                                        ...
                                        >
                                            <path
                                                fillRule="evenodd"
                                                d="M4 2a2 2 0 00-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V7.414a2 2 0 0 0-.586-1.414l-3.414-3.414A2 2 0 0 0 8.586 2H4zm7 5V3.5L15.5 9H11z"
                                                clipRule="evenodd"
                                            />
                                        </svg>
                                    ...
                                    <dd className="inline dark:text-gray-400">
                                        <br />Innovation is at our core. Arionys invests in research to explore emerging technologies, ensuring our clients stay ahead in a fast-evolving tech landscape.
                                    </dd>
                                </div>
                            </dl>
