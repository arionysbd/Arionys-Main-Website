export default async function sitemap() {
    const baseUrl = process.env.SITE_URL || 'https://Arionys.com';
    ...
    try {
        ...
        const additionalWebsites = [
            {
                baseUrl: 'https://code.Arionys.com',
                routes: ['/login', '/dashboard', '/pricing'],
            },
            {
                baseUrl: 'https://meet.Arionys.com',
                routes: ['/', '/login', '/chats', 'calls'],
            },
            {
                baseUrl: 'https:nurahmed.Arionys.com',
                routes: ['/',],
            },
            {
                baseUrl: 'https://chat.Arionys.com',
                routes: ['/', '/login', '/chats', 'calls'],
            },
            {
                baseUrl: 'https://invoice.Arionys.com',
