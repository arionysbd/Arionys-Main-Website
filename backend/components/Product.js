...
export default function Product(
    ...
    async function createProduct(ev) {
        ...
        const data = { title, slug, description, productcategory, tags, status };
    ...
    return <>
        ...
        <form onSubmit={createProduct} className='addWebsiteform'>
            ...
            <div className='w-100 flex flex-col flex-left mb-2' data-aos="fade-up">
                ...
                <select onChange={(e) => setProductcategory(Array.from(e.target.selectedOptions, option => option.value))} name="catergory" id="catergory" multiple value={productcategory} >
                    <option value="htmlcssjs">Html, Css & javaScript</option>
                    <option value="nextjs">Next Js, React js</option>
                    <option value="database">Database</option>
                    <option value="deployment">Deployment</option>
                </select>
                <p className="existingcategory flex gap-1 mt-1 mb-1">Selected: {Array.isArray(existingProductCategory) && existingProductCategory.map(category => (
            ...
            <div className='description w-100 flex flex-col flex-left mb-2'>
                <label htmlFor="description">ABOUT PRODUCTS</label>
                <MarkdownEditor
                    value={description}
